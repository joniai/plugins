...
public class MethodChannelHandler implements MethodChannel.MethodCallHandler {
    ...
    public MethodChannelHandler(BinaryMessenger messenger, Context context) {
    ...
    public void onMethodCall(MethodCall call, MethodChannel.Result result) {
        ...
        switch (call.method) {
            ...
            case "create":
            {
                ...
                MethodChannelHandler.VideoPlayer player;
                if (call.argument("asset") != null) {
                    ...
                    player =
                            new MethodChannelHandler.VideoPlayer(
                                    context,
                                    eventChannel,
                                    handle,
            ...
            default:
            {
                ...
                MethodChannelHandler.VideoPlayer player = videoPlayers.get(textureId);
                if (player == null) {
                    result.error(
                            "Unknown textureId",
    ...
    private void onMethodCall(MethodCall call, MethodChannel.Result result, long textureId, MethodChannelHandler.VideoPlayer player) {
        switch (call.method) {
            case "setLooping":
    ...
    /**
     * Handles necessary cleanups when FlutterView is destroyed.
     */
